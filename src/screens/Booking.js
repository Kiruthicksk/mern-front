...
function Booking() {
 ...
 const handleAddSchedule = async () => {
    try {
      const { data } = await Axios.post("https://wild-cyan-wildebeest-boot.cyclic.app/admin/add-schedule", {
        flightId,
  ...
  const fetchSchedules = async () => {
    try {
      const { data } = await Axios.get("https://wild-cyan-wildebeest-boot.cyclic.app/admin");
      setSchedules(data);
    } catch (err) {
      toast.error(getError(err));
    }
  ...
  const handleBook = async () => {
   ...
   const {data} = await Axios.post(`https://wild-cyan-wildebeest-boot.cyclic.app/customer/add/${userId}`, {
